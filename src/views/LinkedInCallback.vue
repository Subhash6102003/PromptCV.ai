  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50">
    <div class="max-w-md w-full space-y-8">
      ...
      <div class="flex justify-center">
        <div v-if="loading" class="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600"></div>
...
const message = ref('Processing LinkedIn authentication...')
...
const handleLinkedInCallback = async () => {
  try {
    ...
    const tokenResponse = await axios.post('/api/auth/linkedin/token', {
      code,
      clientId,
      clientSecret,
      redirectUri
    ...
    success.value = true
    message.value = 'LinkedIn connected successfully!'
